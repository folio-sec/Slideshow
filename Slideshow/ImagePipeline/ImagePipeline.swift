...
public final class ImagePipeline {
    ...
    public func load(_ url: URL, into imageView: CALayer, defaultImage: NSImage? = nil, failureImage: NSImage? = nil, processors: [ImageProcessing] = []) {
    ...
    private func showImage(_ image: NSImage, completion: @escaping (NSImage) -> Void) {
        DispatchQueue.main.async { completion(image) }
    }

    private func processImage(_ image: NSImage, processors: [ImageProcessing], completion: @escaping (NSImage) -> Void) {
        queue.async {
...
private class ImageViewController {
    ...
    func showImage(_ image: NSImage) {
        reference?.imageView?.contents = image
    }
